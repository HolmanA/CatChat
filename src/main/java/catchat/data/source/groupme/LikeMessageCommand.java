 ...
 */
public class LikeMessageCommand extends ApiCommand<Void> {
    private static final String URL = "https://api.groupme.com/v3/messages/";
    private URL url;

    public LikeMessageCommand(Listener<Void> listener, String chatId, String messageId) throws IOException {
        super(listener);
